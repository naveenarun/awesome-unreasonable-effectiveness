...
- [The Unreasonable Effectiveness of Mathematics in the Natural Sciences](https://personal.lse.ac.uk/ROBERT49/teaching/ph201/Week15_xtra_Wigner.pdf)
- [The “unreasonable effectiveness” of stratigraphic and geomorphic experiments](https://www2.tulane.edu/~kmstraub/Publications/Paola_09.pdf)
- [The Unreasonable Effectiveness of Random Pruning: Return of the Most Naive Baseline for Sparse Training](https://arxiv.org/abs/2202.02643)
...
- [Unreasonable effectiveness of learning neural networks: From accessible states and robust ensembles to basic algorithmic schemes](https://www.pnas.org/doi/10.1073/pnas.1608103113)
...
- [The unreasonable effectiveness of deep learning in artificial intelligence](https://www.pnas.org/doi/10.1073/pnas.1907373117)
- [Untidy Data: The Unreasonable Effectiveness of Tables](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=9555457&tag=1)
- [On the Unusual Effectiveness of Logic in Computer Science](https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=811157902369d690a29d81ab070960d34139a1b3)
- [On The Unreasonable Effectiveness of SAT Solvers](https://www.cs.rice.edu/~vardi/papers/SATSolvers21.pdf)
- [The Unreasonable Effectiveness of Number Theory](http://www.ams.org/books/psapm/046/psapm046-endmatter.pdf)
- [The Unreasonable Effectiveness of Inverse Reinforcement Learning in Advancing Cancer Research](https://ojs.aaai.org/index.php/AAAI/article/view/5380)
- [The unreasonable effectiveness of equilibrium gene regulation through the cell cycle](https://www.biorxiv.org/content/10.1101/2023.03.31.535089v1)
- [The unreasonable effectiveness of tree-based theory for networks with clustering](https://journals.aps.org/pre/abstract/10.1103/PhysRevE.83.036112)
- [The Unreasonable Effectiveness of Deep Features as a Perceptual Metric](https://openaccess.thecvf.com/content_cvpr_2018/papers/Zhang_The_Unreasonable_Effectiveness_CVPR_2018_paper.pdf)
- [On the Unreasonable Effectiveness of the Greedy Algorithm: Greedy Adapts to Sharpness](https://proceedings.mlr.press/v119/pokutta20a.html)
- [The Unreasonable Effectiveness of Transformer Language Models in Grammatical Error Correction](https://aclanthology.org/W19-4412/)
- [The unreasonable effectiveness of small neural ensembles in high-dimensional brain](https://pubmed.ncbi.nlm.nih.gov/30366739/)
- [The Unreasonable Effectiveness of Decoherence](http://philsci-archive.pitt.edu/19125/)
...
- [The Unreasonable Effectiveness of SQL](https://www.couchbase.com/blog/unreasonable-effectiveness-of-sql/)
- [The Unreasonable Syntactic Expressivity of RNNs](http://karpathy.github.io/2015/05/21/rnn-effectiveness/)
